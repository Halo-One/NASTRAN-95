...
C
   ...
   50 PKNL = .FALSE.
      IF (I .NE. 5) GO TO 51
C
C     HALO: PKNL IS MSC'S PK WITH THE DENSITY, MACH AND VELOCITY LISTS
C     WALKED TOGETHER (A MATCHED POINT ANALYSIS). IT RUNS AS PK; ONLY
C     THE FLUTTER LOOP LIST BELOW KNOWS THE DIFFERENCE.
C
      PKNL = .TRUE.
      I = 3
   51 REC0(3) = I
