...
C 
 1000 CONTINUE
      SDMAX = ZERO
      NIDX  = NIDORV/2 + 1 
C     HALO: LOOPS 1080-1110 AS ONE OPTIMISED CALL (MIS/N95TWIN.F),
C     THE SAME ARITHMETIC; THE LOOPS ARE KEPT FOR READING
      CALL FERXTQ (V2,V3,ZD(NIDX),NORD,NORTHO,SDMAX)
      GO TO 2000
      DO 1110 IY = 1, NORTHO
      SD    = ZERO
