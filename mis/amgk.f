...
C
      ...
      INTEGER         N95AEO,N95AEG,IHIT(16),NHIT,IAECV
...
C     PAIRS IT LACKED ARE STORED AFTER GENDK. IAECV NAMES THE KERNEL:
C     A CHANGE TO WHAT GENDK COMPUTES MUST CHANGE IT.
C
      NHIT = 0
