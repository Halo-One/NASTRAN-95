...
C
  ...
  540 CONTINUE
      ...
      M   = BUF3 - I
      N231= N23  - 1
C     HALO: Z(II..NNX) IS SORTED AND FREE OF REPEATS (470-510), SO THE
C     LOOK-UP OF EACH TERM'S SIL (570) IS A BISECTION - THE SAME PLACE,
C     IN LOG TIME. N95SRT CHECKS THE ORDER FIRST, AND AN UNSORTED LIST
C     KEEPS NASA'S LINEAR SEARCH. (ON A MODEL OF A FEW THOUSAND RIGID
C     ELEMENT TERMS THE LINEAR SEARCH WAS A SECOND AND A HALF AT -O0.)
      KSRT = N95SRT(Z(II),NNX-II+1)
  ...
  560 IF (J .GT. NMPC) GO TO 590
      ...
      X(1) = Z(J+N231)
      IF (KSRT .EQ. 0) GO TO 565
      NN1 = N95BSR(IX,Z(II),NNX-II+1)
      IF (NN1 .EQ. 0) GO TO 2540
      NN1 = II + NN1 - 1
      GO TO 580
  565 CONTINUE
      DO 570 NN1 = II,NNX
