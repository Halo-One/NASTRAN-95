...
C
      ...
      CALL FA1PKW (E1,CZ(NB),N,BREF,VEL,IBUF)
      RETURN
 1000 CALL CLOSE (ISCR,3)
      RETURN
      END

      SUBROUTINE FA1PKW (E1,CZ,N,BREF,VEL,IBUF)
C
...
C     RIGID FORMAT RECOVERS, AND THE PRINTED 'EIGENVECTOR FROM THE PK
C     METHOD'. FA1PKV'S OWN STATEMENTS, MOVED; CZ(NB) THERE IS CZ(1).
C
