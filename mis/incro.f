...
C
C
C     HALO: NASTRAN SYSTEM(270)=1 IN THE DECK (THE FRONT END SETS
C     N95_DLM_QUARTIC=1, AS MAY THE USER): THE QUARTIC KERNEL OF RODDEN,
C     TAYLOR AND MCINTOSH 1998 (INCROQ, MIS/DLMQ.F) INSTEAD OF THE
C     PARABOLA BELOW
C
      IF (N95DLQ() .EQ. 0) GO TO 5
      CALL INCROQ (AX,AY,AZ,AX1,AY1,AZ1,AX2,AY2,AZ2,SGR,CGR,SGS,CGS,
     1             1,KR,FL,BETA,SDELX,DELY,DELR,DELI)
      RETURN
    5 IND   = 1
      M     = SQRT(1.0 - BETA**2)
      BR    = FL/2.
