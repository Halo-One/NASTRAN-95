...
C
   ...
   10 DT(I) = (0.0,0.0)
C
C     HALO: THE ROWS COMPUTED SIDE BY SIDE AND PACKED HERE IN ORDER
C     (GENDP, MIS/GENDP.F); N95_DLM_THREADS=1 KEEPS THE LOOP BELOW
C
      CALL GENDP (NCARAY,NBARAY,YS,ZS,SG,CG,DT,WORK,MATOUT,IDONE)
      IF (IDONE .NE. 0) RETURN
C     DPP LOOP
      K = 1
