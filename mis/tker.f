...
C     HALO: THE KERNEL'S SCRATCH, ONE COPY PER THREAD - GEND'S ROWS
C     ARE COMPUTED SIDE BY SIDE (MIS/GENDP.F). EVERY ROUTINE THAT NAMES
C     THESE COMMONS SAYS SO (TKER, INCRO, FLLD, SUBB), OR THE LINK MIXES
C     A THREAD-LOCAL AND AN ORDINARY SYMBOL.
!$OMP THREADPRIVATE (/DLM/,/KDS/)
C
      EPS    = 0.00001
      K10    = 0.0
      K20    = 0.0
