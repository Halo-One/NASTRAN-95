...
21000 IF ( INDX .GE. LASIND ) GO TO 25000
      ...
      IDX2X  = IDX2  + IDROW
      INDXB  = INDXV - IROWB1 
C HALO: LOOP 24000 AS ONE OPTIMISED CALL (N95DOT, MIS/N95TWIN.F), THE
C HALO: SAME PRODUCTS ADDED IN THE SAME ORDER, WHEN THE SUM IS NONE OF
C HALO: ITS TERMS; ELSE THE LOOP
      NIT = IROWN - IROW1 + 1
      IF ( IDX2X+I .GE. INDXAV+IROW1 .AND.
     &     IDX2X+I .LE. INDXAV+IROWN ) GO TO 23900
      IF ( IDX2X+I .GE. INDXB+IROW1 .AND.
     &     IDX2X+I .LE. INDXB+IROWN ) GO TO 23900
      CALL N95DOT ( ZD(IDX2X+I), ZD(INDXAV+IROW1), ZD(INDXB+IROW1),
     &              NIT, 1 )
      GO TO 21000
23900 CONTINUE
